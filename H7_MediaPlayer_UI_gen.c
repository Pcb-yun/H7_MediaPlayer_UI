...
static uint32_t H7_MediaPlayer_UI_target = H7_MEDIAPLAYER_UI_TARGET_ALL;
...
{
    H7_MediaPlayer_UI_target = target;
}

uint32_t H7_MediaPlayer_UI_get_target(void)
{
    return H7_MediaPlayer_UI_target;
}

bool H7_MediaPlayer_UI_check_target(uint32_t target)
{
    return (H7_MediaPlayer_UI_target & target) ? true : false;
}
